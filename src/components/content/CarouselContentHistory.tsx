...
export default function CarouselContentHistory({ session }: ContentHistoryPageProps) {
            ...
            <div className="flex justify-between items-center mt-3">
              <div>
                ...
                <Text variant="bodySm" tone="subdued">
                  Manage and track your contents
                </Text>
              </div>
              <Button
                variant="primary"
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col max-w-8xl mx-auto px-4 sm:px-6 py-4">
              {filteredContents.length > 0 ? (
                ...
                >
                  <p>Get started by publishing your first content</p>
                </EmptyState>
              )}
